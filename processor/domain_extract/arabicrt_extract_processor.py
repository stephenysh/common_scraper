...
def arabicrt_extractor(line: str) -> Optional[str]:
    ...
    return json.dumps(
        dict(url=url, title=title, label=arab_label_word, url_label=url_label, href_label=href_label, label_id=label_id,
